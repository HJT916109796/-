...
@interface HKTransitionTool()<CAAnimationDelegate>
...
+ (void)hk_showAnimationForContainerView:(UIView*)containerView withTransitionStyle:(HKTransitionStyle)transitionStyle completion:(void(^)(void))completion {
    [[HKTransitionTool shareManager] hk_showAnimationForContainerView:containerView withTransitionStyle:transitionStyle completion:completion];
}
...
+ (void)hk_disappearAnimationForContainerView:(UIView*)containerView withTransitionStyle:(HKTransitionStyle)transitionStyle completion:(void(^)(void))completion{
    [[HKTransitionTool shareManager] hk_disappearAnimationForContainerView:containerView withTransitionStyle:transitionStyle completion:completion];
}
/**
 *  进入的动画 show animation
 */
